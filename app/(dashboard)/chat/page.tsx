  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <SidebarInset className="flex-1 flex flex-col relative overflow-hidden">
        {/* 로딩 화면 */}
        {isConnecting ? (
          <div className="flex-1 flex flex-col items-center justify-center bg-white/95 backdrop-blur-xl z-50">
            <div className="mb-8 relative">
              <SoriCharacter size={80} animated={true} />
          ...
          <>
            ...
            {activeTab === 'live' && (
              <div className="flex-1 flex flex-col h-[calc(100vh-65px)]">
                {/* 헤더 */}
                <div className="bg-white/90 backdrop-blur-xl border-b border-slate-200 shadow-sm flex-shrink-0">
                ...
                {/* 실시간 분석 패널 */}
                {showAnalysis && (
                  <div className="border-t border-slate-200 bg-white/90 backdrop-blur-xl p-6 animate-slideInUp flex-shrink-0">
