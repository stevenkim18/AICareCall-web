...
// V5: 대시보드 + 탭 - 메인 대시보드와 리스트를 탭으로 구분
export default function DashboardLayoutV5() {
          ...
          {activeTab === 'dashboard' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 bg-white rounded-md shadow-sm border border-slate-200 p-6 min-h-[500px] flex flex-col">
