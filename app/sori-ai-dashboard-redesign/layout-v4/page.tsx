...
// V4: 타임라인 중심 - 시간 흐름에 따라 정보를 배치
export default function DashboardLayoutV4() {
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white rounded-md shadow-sm border border-slate-200 p-6 flex flex-col">
